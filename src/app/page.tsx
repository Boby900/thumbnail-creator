...
import i from '@/app/icons8-app-store-500.png'
      ...
      <section className="">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-5xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-slate-300">
            ...
            <SignedIn>
            <Button className="bg-slate-300" asChild>
              <Link className="font-bold text-black"  href="/create">Get Started</Link>
            </Button>
            </SignedIn>
          </div>
